 ...
 * Smart Triggers player process crashes or is backgrounded unexpectedly.
 *
...
public class WatchdogService extends Service {
    ...
    private static final String CHANNEL_ID            = "digipal_smart_player_watchdog";
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (nm != null && nm.getNotificationChannel(CHANNEL_ID) == null) {
                NotificationChannel ch = new NotificationChannel(
                    CHANNEL_ID,
                    "Digipal Smart Player",
                    NotificationManager.IMPORTANCE_MIN
                );
                ch.setDescription("Keeps Digipal Smart Player running");
    ...
    private Notification buildNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            return new Notification.Builder(this, CHANNEL_ID)
                .setContentTitle("Digipal Smart Player")
