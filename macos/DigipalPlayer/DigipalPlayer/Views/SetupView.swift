import SwiftUI
  ...
  struct SetupView: View {
      ...
      var body: some View {
              ...
              VStack(spacing: 0) {
                  ...
                  VStack(spacing: 24) {
                      ...
                      VStack(alignment: .leading, spacing: 8) {
                          ...
                          if !networkScanner.discoveredServers.isEmpty {
                              ForEach(networkScanner.discoveredServers, id: \.url) { hub in
                                  hubRow(name: hub.name, url: hub.url, source: "Network Scan")
                              }
                          }
                      }
          ...
          .onChange(of: networkScanner.discoveredServers) { hubs in
              updateScanStatus()
          }
      ...
      private func updateScanStatus() {
          let totalFound = bonjourBrowser.discoveredServers.count + networkScanner.discoveredServers.count
